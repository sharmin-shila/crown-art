      ...
      <footer className="px-5 pt-10 pb-4 rounded-md mt-12 text-base-content">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 md:place-items-start">
          ...
          <div className="text-white flex flex-col justify-center items-center">
            <p className="mb-2 font-bold uppercase text-[#90c641e6]">Contact</p>
          ...
          <div className="text-white flex flex-col justify-center items-center">
            <p className="mb-2 font-bold uppercase text-[#90c641e6]">Social</p>
          ...
          <div className="text-white flex flex-col justify-center items-center">
            <p className="mb-2 font-bold uppercase text-[#90c641e6]">Address</p>
